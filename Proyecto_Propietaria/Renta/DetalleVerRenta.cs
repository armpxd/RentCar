...
{
    public partial class DetalleVerRenta : Form
    {
        public DetalleVerRenta()
        {
            InitializeComponent();
        }
        private int? id;
        int? employee;
        public DetalleVerRenta( int? id = null, int? employe = null)
        {
            InitializeComponent();
            this.id = id;
            ...
            using (RentCarEntities db = new RentCarEntities())
            {
                ...
                dateTimePicker2.Value = renta.date_devolution.HasValue ? renta.date_devolution.Value :renta.date_rent ;
                textdevolucion.Text = renta.Comment_devolution;
            }
